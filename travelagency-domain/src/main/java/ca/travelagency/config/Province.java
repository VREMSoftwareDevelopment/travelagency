...
@Entity
public class Province implements DaoEntity, Comparable<Province> {
	private static final long serialVersionUID = 1L;

	public static Province make(String name) {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(getName(), ((Province) object).getName()).isEquals();
	}
