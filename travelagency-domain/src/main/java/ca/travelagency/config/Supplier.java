...
@Entity
public class Supplier implements DaoEntity, Comparable<Supplier> {
	private static final long serialVersionUID = 1L;

	public static Supplier make(String name) {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(getName(), ((Supplier) object).getName()).isEquals();
	}
